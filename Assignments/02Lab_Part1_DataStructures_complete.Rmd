...
# **COMBINES THE TWO VECTORS, COERCES DATA TYPE** 
c(vector1, vector4)

# **MULTIPLIES VALUES**
vector1 * vector4 

# **MULTIPLIES ALL VECTOR VALUES BY A SINGLE VALUE**
vector1 * 10

# **CONVERTS CHARACTERS TO UPPER CASE**
toupper(vector2) 

# **INVERTS VALUES A BOOLEAN VECTOR**
!vector3
...
matrix1[4, 1] # **RETURNS THE VALUE IN THE 4th ROW, 1st COLUMN**

matrix1[4,  ] # **RETURNS ALL VALUES IN THE 4th ROW**

matrix1[ , 3] # **RETURNS THE VALUE IN THE 3rd COLUMN**

matrix1[c(12, 14)] # **RETURNS THE VALUE IN THE 12th ROW, 14th COLUMN**

matrix2[c(12:14)] # **RETURNS SLICE OF 12th THRU 14th VALUE, IF GOING DOWN COLUMNS, ROW BY ROW**

matrix1[2:4, 1:3] # **RETURNS SLICE: ROWS 2-4 & COLUMNS 1-3
...
matrix4 # **MATRIX INCLUDES SPECIFIED ROW AND COLUMN NAMES
...
# **SHOW THE ITEM ASSOCIATED WITH THE KEY "age"**
list1$age

# **SHOW THE KEYS IN THE LIST
names(list1)

# **SHOW THE FIRST TWO ITEMS IN THE LIST**
list1[1:2]

# **UPDATE THE VALUE ASSOCATED WITH THE KEY "name"**
list1$name = "Janelle"
